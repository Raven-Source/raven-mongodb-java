...
// * @author yi.liang
// */
//public class AsyncMongoRepositoryImpl<TEntity extends Entity<TKey>, TKey>
//        extends AsyncMongoReadonlyRepositoryImpl<TEntity, TKey>
//        implements AsyncMongoRepository<TEntity, TKey> {
//
//    //#region constructor
//
//    /**
...
//     */
//    public AsyncMongoRepositoryImpl(final ReactiveMongoSession mongoSession, final String collectionName, final Sequence sequence
...
//     * @param mongoSession ReactiveMongoSession
//     */
//    public AsyncMongoRepositoryImpl(final ReactiveMongoSession mongoSession) {
//        super(mongoSession);
//    }
//
//    /**
...
//     * @param collectionName collectionName
//     */
//    public AsyncMongoRepositoryImpl(final ReactiveMongoSession mongoSession, final String collectionName) {
...
//     */
//    public AsyncMongoRepositoryImpl(final ReactiveMongoSession mongoSession, final MongoOptions mongoOptions) {
...
//     * @param collectionName collectionName
//     */
//    public AsyncMongoRepositoryImpl(final ReactiveMongoSession mongoSession, final MongoOptions mongoOptions, final String collectionName) {
...
//     */
//    @Override
//    public CompletableFuture<UpdateResult> updateOne(final Bson filter, final TEntity updateEntity, final boolean isUpsert, final Bson hint, final WriteConcern writeConcern) {
//
...
//     */
//    @Override
//    public CompletableFuture<TEntity> findOneAndUpdate(final Bson filter, final TEntity entity, final boolean isUpsert, final Bson sort, final Bson hint) {
//
...
//    //region protected
//
//    protected CompletableFuture<InsertOneResult> doInsert(final TEntity entity, final WriteConcern writeConcern) {
//
...
//    }
//
//    protected CompletableFuture<InsertManyResult> doInsertBatch(final List<TEntity> entities, final WriteConcern writeConcern) {
//
...
//
//    @Override
//    public ModifyProxy<TEntity, TKey, CompletableFuture<InsertOneResult>, CompletableFuture<InsertManyResult>, CompletableFuture<UpdateResult>, CompletableFuture<TEntity>, CompletableFuture<DeleteResult>> modifyProxy() {
//        return proxy;
//    }
//
//    private final ModifyProxy<TEntity, TKey, CompletableFuture<InsertOneResult>, CompletableFuture<InsertManyResult>, CompletableFuture<UpdateResult>, CompletableFuture<TEntity>, CompletableFuture<DeleteResult>> proxy =
//            new ModifyProxy<>() {
//
//                @Override
...
//
//                @Override
//                protected CompletableFuture<InsertOneResult> doInsert(TEntity entity, WriteConcern writeConcern) {
//                    return AsyncMongoRepositoryImpl.this.doInsert(entity, writeConcern);
//                }
//
//                @Override
//                protected CompletableFuture<InsertManyResult> doInsertBatch(List<TEntity> entities, WriteConcern writeConcern) {
//                    return AsyncMongoRepositoryImpl.this.doInsertBatch(entities, writeConcern);
//                }
//
//                @Override
//                protected CompletableFuture<UpdateResult> doUpdate(@NonNull org.raven.mongodb.repository.UpdateOptions options, UpdateType updateType) {
//                    return AsyncMongoRepositoryImpl.this.doUpdate(options, updateType);
//                }
//
//                @Override
//                protected CompletableFuture<TEntity> doFindOneAndUpdate(org.raven.mongodb.repository.FindOneAndUpdateOptions options) {
//                    return AsyncMongoRepositoryImpl.this.doFindOneAndUpdate(options);
//                }
//
//                @Override
//                protected CompletableFuture<TEntity> doFindOneAndDelete(@NonNull org.raven.mongodb.repository.FindOneAndDeleteOptions options) {
//                    return AsyncMongoRepositoryImpl.this.doFindOneAndDelete(options);
//                }
//
//                @Override
//                protected CompletableFuture<DeleteResult> doDeleteOne(org.raven.mongodb.repository.DeleteOptions options) {
//                    return AsyncMongoRepositoryImpl.this.doDeleteOne(options);
//                }
//
//                @Override
//                protected CompletableFuture<DeleteResult> doDeleteMany(org.raven.mongodb.repository.DeleteOptions options) {
//                    return AsyncMongoRepositoryImpl.this.doDeleteMany(options);
//                }
//            };
//}
