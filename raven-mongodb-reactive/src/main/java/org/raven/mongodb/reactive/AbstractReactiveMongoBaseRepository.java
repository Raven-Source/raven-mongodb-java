...
public abstract class AbstractReactiveMongoBaseRepository<TEntity extends Entity<TKey>, TKey>
    ...
    //#region constructor
    public AbstractReactiveMongoBaseRepository(@Nullable final ReactiveMongoSession mongoSession
     ...
     */
    public AbstractReactiveMongoBaseRepository(Class<TEntity> entityClazz, Class<TKey> keyClazz
            , @Nullable final ReactiveMongoSession mongoSession
            , @Nullable final String collectionName
            , @Nullable final IdGeneratorProvider<ReactiveIdGenerator<TKey>, MongoDatabase> idGeneratorProvider) {
