...
public class FilterBuilderTest {
    ...
    public void filterTest() {
        ...
        Bson filter = FilterBuilder.create(Orders.class)
                .add(x -> x
                        .orOperator()
                        .gt(Fields.price, 198)
        ...
        log.info(filter.toBsonDocument().toJson());
    }
    ...
    public void bsonDocTest() {
        ...
        Bson bson = filterBuilder.build();
        log.info(bson.toBsonDocument().toJson());
        Assert.assertEquals("{\"$and\": [{\"a\": \"1\"}, {\"b\": {\"$ne\": 2}}, {\"c\": {\"$gt\": 3}}, {\"d\": {\"$lt\": 4}}, {\"e\": {\"$gte\": 5}}, {\"f\": {\"$lte\": 6}}, {\"g\": {\"$in\": [7, 8, 9]}}, {\"h\": {\"$nin\": [10, 11, 12]}}, {\"x\": null}, {\"y\": {\"$ne\": null}}]}",
                bson.toBsonDocument().toJson()
        );
        ...
        log.info(bson.toBsonDocument().toJson());
        Assert.assertEquals("{\"$or\": [{\"a\": \"1\"}, {\"b\": {\"$ne\": 2}}, {\"c\": {\"$gt\": 3}}, {\"d\": {\"$lt\": 4}}, {\"e\": {\"$gte\": 5}}, {\"f\": {\"$lte\": 6}}, {\"g\": {\"$in\": [7, 8, 9]}}, {\"h\": {\"$nin\": [10, 11, 12]}}, {\"x\": null}, {\"y\": {\"$ne\": null}}]}",
                bson.toBsonDocument().toJson()
        );
        ...
        bson = filterBuilder.build();
        log.info(bson.toBsonDocument().toJson());
        Assert.assertEquals("{\"$nor\": [{\"a\": \"1\"}, {\"b\": {\"$ne\": 2}}, {\"c\": {\"$gt\": 3}}, {\"d\": {\"$lt\": 4}}, {\"e\": {\"$gte\": 5}}, {\"f\": {\"$lte\": 6}}, {\"g\": {\"$in\": [7, 8, 9]}}, {\"h\": {\"$nin\": [10, 11, 12]}}, {\"x\": null}, {\"y\": {\"$ne\": null}}]}",
                bson.toBsonDocument().toJson()
        );
    }
